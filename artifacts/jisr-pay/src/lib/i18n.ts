...
export const strings = {
  en: {
    ...
    remoteLogout: 'Sign out of backup',
    remoteRefresh: 'Refresh backup',
    remoteBusy: 'Working…',
    remoteReady: 'Signed in to your wallet history.',
    remoteError: 'Could not complete this request. Your local history is unchanged. Try again later.',
    remoteExpired: 'Session ended. Reconnect the intended Testnet wallet and sign in again.',
    remoteWallet: 'Login was cancelled or the wallet changed. Select the connected account on Testnet and try again.',
    ...
    remoteEmpty: 'No backed-up records loaded.',
    remoteRestore: 'Restore to this browser',
    remoteMore: 'Load more',
  ...
  ar: {
    ...
    remoteLogout: 'تسجيل الخروج من النسخة الاحتياطية',
    remoteRefresh: 'تحديث النسخة الاحتياطية',
    remoteBusy: 'جارٍ العمل…',
    remoteReady: 'تم تسجيل الدخول إلى سجل محفظتك.',
    remoteError: 'تعذّر إكمال الطلب. لم يتغير سجلك المحلي. حاول لاحقًا.',
    remoteExpired: 'انتهت الجلسة. أعد توصيل محفظة الاختبار المطلوبة وسجّل الدخول مجددًا.',
    remoteWallet: 'أُلغي الدخول أو تغيّرت المحفظة. اختر الحساب المتصل على شبكة الاختبار وحاول مجددًا.',
    ...
    remoteEmpty: 'لم يتم تحميل سجلات احتياطية.',
    remoteRestore: 'استعادة إلى هذا المتصفح',
    remoteMore: 'تحميل المزيد',
